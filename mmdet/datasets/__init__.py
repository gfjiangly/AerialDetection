...
from .HRSC import HRSCDataset, HRSCL1Dataset, HRSCL2Dataset, HRSCL3Dataset
...
__all__ = [
    ...
    'ExtraAugmentation', 'HRSCDataset', 'HRSCL1Dataset', 'HRSCL2Dataset', 'HRSCL3Dataset', 
    'DOTADataset_v3', 'DOTA1_5Dataset', 'DOTA1_5Dataset_v3', 'DOTA1_5Dataset_v2',
    'DOTA2Dataset_v4'
]
