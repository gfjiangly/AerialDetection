...
model = dict(
    type='RoITransformer',
    pretrained='/media/data/pretrain_model/resnet50-19c8e357.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'Train/ori_train.json',
        ...
        with_label=True,
        levels=('L1', 'L2', 'L3'),
        L2_class_map_file=data_root + 'L2_class_map.txt',
        L3_class_map_file=data_root + 'L3_class_map.txt'),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'Test/ori_test.json',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_RoITrans_r50_fpn_1x_dota_hrsc2016'
load_from = None
resume_from = None
workflow = [('train', 1)]
